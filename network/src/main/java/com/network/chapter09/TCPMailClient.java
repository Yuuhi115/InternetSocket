...
public class TCPMailClient {
  private SSLSocket socket; //定义SSL套接字 7
  //定义SSL工厂类
  ...
  public TCPMailClient(String smtpAddress, String smtpPort) throws IOException {
    factory = (SSLSocketFactory)SSLSocketFactory.getDefault();
    //创建安全套接字实例
    socket = (SSLSocket)factory.createSocket(smtpAddress, Integer.parseInt(smtpPort));
